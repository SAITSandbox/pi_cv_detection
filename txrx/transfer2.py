        ...
        while True:
            ...
            if not client_authorised:
                ...
                if raw_message == "Files":
                    self.send_msg(client_socket, "2")

                elif raw_message == "0":
                    self.send_msg(client_socket, "Data")
                    self.send_msg(client_socket, "Test Data 1234")
                    self.send_msg(client_socket, "'end'")
                ...
                elif raw_message == "send":
                    time.sleep(1)
                    self.send_data(client_socket)

                else:
                    msg = input("Message: "+raw_message)
